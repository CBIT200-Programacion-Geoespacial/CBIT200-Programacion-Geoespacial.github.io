...
es básicamente la misma que `od`, a anterior, s[olo que se puede
...
Podemos usar mapview para explorar los datos de forma interactiva, usando la columna `year` paraver como se ha muestreado a través de los años.
...
od_sf |>
  ...
  ggplot(aes(x=year,y=n)) +
    ...
    geom_smooth(method = 'lm', formula = y~x,alpha=.6)
...
```
Vemos que el esfuerzo de muestro es espacialmente heterogeneo.
