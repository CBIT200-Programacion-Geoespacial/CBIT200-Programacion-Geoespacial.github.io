...
kable(Summary.Petal) |> kable_styling(bootstrap_options = 
...
- sin recurrir a paréntesis anidados 
- sobrescribir múltiples bases de datos
...
- **tiene** que contener un operador en su argumento

```{r, echo=FALSE}
DF <- data.frame(operador = c(">", "<", "==", ">=", "<="), significado = c("Mayor que", "Menor que", "Igual a", "mayor o igual a", "menor o igual a"), operador_cont = c("!=","%in%", "is.na", "!is.na", "| &"), significado_cont = c("distinto a", "dentro del grupo", "es NA", "no es NA", "o, y"))
...
kable(DF) |> kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                           full_width = TRUE,font_size = 16, html_font = "Avenir")
```
